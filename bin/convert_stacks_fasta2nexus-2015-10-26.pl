...
my ($stacks_fasta_infile, $stacks_popmap_infile, $project_name, $whitelist_infile, $percent_present_data, $output_dir);
GetOptions(
...
Usage: $0 -i stacks_input_dir -f stacks_fasta_infile -n project_name -w whitelist_infile -p percent_present_data -o output_dir
